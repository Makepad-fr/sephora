...
export default class Sephora {
  ...
  /**
     ...
     */
  public static async init(browser: 'chrome' | 'firefox' | 'webkit', launchOptions: LaunchOptions, contextOptions?: BrowserContextOptions, authenticatedContextPath: string = 'linkedjs.json'): Promise<Sephora> {
    ...
    await page.click("//button[contains(@id,'footer_tc_privacy_button_2')]");
   ...
   */
  public async productDetails(isolated: boolean = true): Promise<ProductDetails> {
    const u: ProductDetails = new ProductDetails(isolated
